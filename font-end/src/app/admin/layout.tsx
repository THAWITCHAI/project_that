                        ...
                        <div className='flex justify-center items-center h-[100vh]'>
                            <div className="w-[16%] border h-full bg-white flex flex-col justify-start items-center gap-2">
                                <div className='border-b border-dotted border-slate-500 w-full flex justify-center items-center gap-2 py-2 px-5'>
                                    <Image src={`/uploads/${session.user.profileImage}`} width={40} height={40} alt='' className='rounded-full w-[40px] h-[40px]' />
                                    <div className='text-[16px] font-medium text-black'>{session.user.name}</div>
                                </div>
                                <div className="w-full h-full flex flex-col justify-start items-center gap-2 p-2">
                                    ...
                                    <button className="w-full hover:bg-[#d7e5ff] rounded-sm h-[2.5rem] px-2 group flex justify-stretch mt-3 gap-2 items-center">
                                        <Link className="w-full flex gap-2 justify-start items-center" href={''}>
                                            ...
                                            <div className=" text-gray-500 text-sm group-hover:text-red-500 transition-colors duration-300">
                                                <Link href={'/api/auth/signout?csrf=true'}>ออกจากระบบ</Link>
                                            </div>
                                        </Link>
                                    </button>
                                </div>
